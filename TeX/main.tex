...
The ensemble of all five models produces higher accuracy, precision, recall, and F1-scores than the majority of individual models and above the mean for each metric.
...
While it is not custom to run several models on the test set, I do so sparingly in this project to demonstrate the effects of additional context, which may provide direction for future research and development.2
