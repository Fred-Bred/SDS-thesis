...
The labelled data for this project consists of the majority of the English part of the datasets from the 2014 and 2017 validation studies of the PACS \cite{Talia2017, Talia2014}.
This data was originally collected for other research projects.
...
\end{itemize}
The majority class in this dataset is preoccupied.
As noted, it was shown by Feeney and Ryan \cite{Feeney1994} that those with preoccupied attachment styles were more prone to seeking medical attention and more likely to report having had therapy.
...
This sample may be different from the average clnical sample in its high prevalence of psychiatric diagnoses. Talia et al. \cite{Talia2014} report that in the 2014 study, 77 \% of the patients received an Axis I diagnosis and 31 \% of the patients received an Axis II diagnosis; 27 \% of the patients received both Axis I and Axis II diagnoses.
