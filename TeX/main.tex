...
This mediating role of the alliance has been the focus of more recent research. In a review of 37 studies on the basis of their findings and the extent to which they meet criteria for mechanistic research, Baier, Kline, and Feeny \cite{Baier2020} found that the therapeutic alliance mediated therapeutic outcomes in 70 \% of the studies included.

\subsubsection*{Patient attachment and therapeutic alliance}
While it is important to distinguish between the therapeutic alliance and the therapeutic relationship more broadly, they are undeniably closely related. So much so, that measures of the therapeutic relationship in attachment terms may overlap with and in some cases stand in for measures of the alliance in lieu of the latter.
