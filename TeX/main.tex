...
The lack of evidence supporting the theorised notion of attachment changes in response to life events may be a least partially explained by more pragmatic factors. Namely, studying relevant life events is difficult for a number of reasons. First, identifying which potential events are relevant is a challenging and potentially endless task. Second, quantifying these events and reliably tracking them poses its own set of challenges. Finally, the measurement of this theorised effect likely requires elaborate longitudinal study designs, making its investigation difficult.
