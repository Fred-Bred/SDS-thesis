...
Taking a majority vote between the five models to determine one prediction per sample in the test set produces the following confusion matrix.
% $$
...
Confusion matrices for the five individual models are included in Appendix \ref{App: confusion matrices}.
