...
\makeatletter
\newcommand{\supervisors}[1]{\def\@supervisors{#1}} % Define a new command for the supervisors
...
\renewcommand{\maketitle}{
    \begin{titlepage}
        \centering
        % \includegraphics[width=\paperwidth]{figures/KU_SAMF_logo.pdf}\par\vspace{1cm} % Include a logo
        % \vspace{1cm}
        ...
        \textsc{\large Supervisors: \@supervisors}\par\vspace{1cm} % Use the \supervisors command to get the supervisors
        \@date % Use the \date command to get the date
        \vfill
...
\supervisors{Rosa Ellen Lavelle-Hill \& Sandro Ferreira Sousa}
