...
\begin{figure}
    \includegraphics[width=\textwidth]{full_turn_length_distribution.png}
...
\begin{figure}
    \includegraphics[width=\textwidth]{metrics_by_length_2024.03.13_11.54.44_model 7 2.png}
    \caption{Example of accuracy over turn length for one model experiment}
    \label{fig: acc over turn len}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{turn_length_distribution_by_class.png}
